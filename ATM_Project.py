        ...
        try:
            ...
            if id_to_transfer in user_ids:
                if amount > int(self.get_user_balance()):
                    ...
                    print("""\n€({}) ====>>>> ID_Number ({}) ***Successfully sent***""".format(amount,id_to_transfer))
                    print("""\n€({}) successfully sent to ID_Number ({})""".format(amount, id_to_transfer))
                    print("\nTo do more,go back to the ___Main Menu___")
            else:
...
Please DON'T FORGET your credentials! You are going to login with this data!
        ...
        """.format(new_user_name,new_password,new_email)
        print(new_user_information)
